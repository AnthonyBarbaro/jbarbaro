  ...
  if (compact) {
    return (
      <Link
        ...
        onClick={onNavigate}
        className={cn(
          "inline-flex h-11 w-11 items-center justify-center rounded-md border border-ink/12 text-ink transition-colors duration-200 hover:border-deep-teal focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-deep-teal focus-visible:ring-offset-2",
          className,
        )}

...
const baseInputClass =
  "mt-1 w-full rounded-md border border-ink/20 bg-ivory px-3 py-2.5 text-base text-ink outline-none transition-all placeholder:text-smoke/80 focus:border-deep-teal focus:ring-4 focus:ring-deep-teal/15 sm:text-sm";

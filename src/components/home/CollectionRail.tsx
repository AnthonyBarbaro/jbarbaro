  ...
  return (
    <section aria-labelledby={`${railId}-heading`} className="bg-[#f8f5ee]">
      <div className="flex items-center justify-between gap-3 border-b border-ink/15 px-4 py-4 sm:px-6 lg:px-8 xl:px-10 2xl:px-12">
        ...
        <Link
          href="/categories"
          className="group inline-flex min-h-11 shrink-0 items-center gap-1.5 px-1 text-xs font-semibold tracking-[0.12em] text-deep-teal uppercase transition-colors hover:text-ink focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-deep-teal focus-visible:ring-offset-2"

      ...
      <WaveSection topWave="B" bottomWave="C" background="ivory">
        <Container>
          <article className="mx-auto max-w-4xl">
            ...
            <h1 className="mt-4 font-heading text-3xl leading-tight text-ink sm:text-5xl lg:text-6xl">
              {post.title}
            </h1>
            <p className="mt-4 text-sm font-semibold tracking-[0.08em] text-smoke uppercase">
              By {post.author}
            </p>
            ...
            <div className="mt-12 grid gap-4 sm:grid-cols-2">
              <Card tone="stone">
                <CardContent>
                  <h2 className="font-heading text-2xl text-ink sm:text-3xl">
                    Ready for In-Person Guidance?
                  </h2>
                  <p className="mt-3 text-sm leading-7 text-smoke">
                    Book an appointment and we&apos;ll translate these recommendations into a
                    curated fitting session.
                  </p>
              ...
              <Card>
                <CardContent>
                  ...
                  <Link
                    href="/style-guide"
                    className="mt-3 block text-sm text-deep-teal hover:text-ink"
                  >
                    Explore Style Guide →
                  </Link>
                  <Link href="/blog" className="mt-2 block text-sm text-deep-teal hover:text-ink">
                    Back to Blog Index →
                  </Link>
                </CardContent>
              </Card>
